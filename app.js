const menu = [
  ...
  /* Butonları Arayüzümüze ekliyoruz */
  ...
  const btnKorean = document.querySelector("#Korea").addEventListener("click", listKoreanFoods);
  const btnJapan = document.querySelector("#Japan").addEventListener("clic", listJapanFoods);
  const btnChina = document.querySelector("#China").addEventListener("click", listChinaFoods);

  /* Bütün Yemeklerin Sayfa Yüklenmesiyle All Butonunun işleviyle Anasayfaya Dökülmesi */
  ...
  /* Kore Yemeklerini Listelemek İçin */
  ...
  /* Japan Yemeklerini Listelemek İçin */
...
/* China Yemeklerini Listelemek İçin */
